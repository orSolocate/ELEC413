...
%arm_length=2.5e-6;
Period=316e-9;  % 318
n_eff=2.44 - 1.13 * ((Lambda/1000.0)-1.550)-0.043*((Lambda/1000.0)-1.550)^2; %2.44
...
delta_n=0.09;    % 0.04 Index contrast between n1 and n2, matches to dw=40nm
n1=n_eff-delta_n/2;
n2=n_eff+delta_n/2;
